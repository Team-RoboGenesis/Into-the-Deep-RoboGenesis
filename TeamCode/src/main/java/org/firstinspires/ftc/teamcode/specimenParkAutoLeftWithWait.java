...
@com.qualcomm.robotcore.eventloop.opmode.Autonomous(name = "specimenParkAutoLeftWithWait")
public class specimenParkAutoLeftWithWait extends LinearOpMode {
