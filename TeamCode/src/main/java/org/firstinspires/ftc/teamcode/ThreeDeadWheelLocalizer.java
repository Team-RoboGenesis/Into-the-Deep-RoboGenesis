...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 1902.984265825154; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -1902.984265825154; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 1809.8577947987383; // x position of the perpendicular encoder (in tick units)
    }
